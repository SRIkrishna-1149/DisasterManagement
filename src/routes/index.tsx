...
function HomeRoute() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-surface to-surface-2 p-6 sm:p-10">
        <div className="relative max-w-3xl">
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-muted-foreground">
            ...
            to responders—with real road routes and GPS tracking across India.
          </p>
        ...
        <section className="rounded-xl border border-accent/60 bg-accent/15 p-4 sm:p-5 animate-in fade-in">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">{userDistrictAlert.description}</p>
            </div>
